...
'''
class GameFrame2016(QtGui.QFrame):
    def __init__(self):
        ...
        #Combo boxes
        self.lowBarLabel = QtGui.QLabel("")
        self.lowBarLabel.setPixmap(self.lowBarPixmap.scaledToWidth(100))
        self.obstacle2Box2016 = QtGui.QComboBox() #Box 2
        ...
        self.obstacle3Box2016 = QtGui.QComboBox() #Box 3
        ...
        self.obstacle4Box2016 = QtGui.QComboBox() #Box 4
        ...
        self.obstacle5Box2016 = QtGui.QComboBox() #Box 5
        ...
        self.noSetPositionLabel = QtGui.QLabel("No Set Position")
        self.noSetPositionLabel.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignVCenter)

        self.positionButtonGroup = QtGui.QButtonGroup()
        self.position1Label = RobotPosition.RobotPosition(self.blankPixmap.scaledToWidth(self.iconSize))
        self.position2Label = RobotPosition.RobotPosition(self.blankPixmap.scaledToWidth(self.iconSize))
        self.position3Label = RobotPosition.RobotPosition(self.blankPixmap.scaledToWidth(self.iconSize))
        self.position4Label = RobotPosition.RobotPosition(self.blankPixmap.scaledToWidth(self.iconSize))
        self.position5Label = RobotPosition.RobotPosition(self.blankPixmap.scaledToWidth(self.iconSize))
        self.unpositionedLabel = RobotPosition.RobotPosition(self.robotPixmap.scaledToWidth(self.iconSize))
        ...
        self.grid2016 = QtGui.QGridLayout()
