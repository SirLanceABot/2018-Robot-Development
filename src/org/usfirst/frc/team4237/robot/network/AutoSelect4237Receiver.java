 ...
 */
public class AutoSelect4237Receiver extends Thread	
{
	...
	private static AutoSelect4237Receiver instance;

	static //Static block to get around the constructor throwing IOException
	{
		try	
		{
			instance = new AutoSelect4237Receiver(); 
		}
		catch(IOException e)
		{
			e.printStackTrace();
	 ...
	 */
	public static AutoSelect4237Receiver getInstance()
	{
		return instance;
	}

	private AutoSelect4237Receiver() throws IOException
	{
	...
	public static class Constants
	{
		...
		private static final int PORT = 5803;
	}
}
